...
const rootDomainName = app.node.tryGetContext('rootDomainName');
...
const enableCustomDomains = app.node.tryGetContext('enableCustomDomains') === 'true';
if (!['dev', 'staging', 'prod'].includes(env)) {
    throw new Error(`Invalid env "${env}". Must be dev | staging | prod.`);
}
new learnfyra_stack_1.LearnfyraStack(app, `LearnfyraStack-${env}`, {
    env: {
