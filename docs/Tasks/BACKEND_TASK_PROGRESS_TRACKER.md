...
Inputs: docs/specs/modules/M02-question-bank-spec.md, docs/specs/modules/M03-worksheet-generator-spec.md, docs/Tasks/BACKEND_TASK_PROGRESS_TRACKER.md
...
Inputs: docs/specs/modules/M03-worksheet-generator-spec.md, docs/worksheet_architecture.md, src/ai/generator.js
...
Inputs: docs/Tasks/BACKEND_TASK_PROGRESS_TRACKER.md, all backend API contracts from M01-M07/INT
...
Inputs: infra/cdk/lib/learnfyra-stack.ts, backend/handlers/*.js, docs/Tasks/BACKEND_TASK_PROGRESS_TRACKER.md
...
Inputs: .github/workflows/deploy-dev.yml, .github/workflows/deploy-staging.yml, .github/workflows/deploy-prod.yml, docs/operations/NEXT_PHASE_MASTER_DOSSIER.md
