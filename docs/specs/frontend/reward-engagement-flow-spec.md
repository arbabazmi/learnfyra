...
1. Module architecture and mode control: [docs/specs/backend/auth-online-offline-reporting-spec.md](docs/specs/backend/auth-online-offline-reporting-spec.md)
...
4. QA auth/reporting coverage: [docs/qa/backend/auth-mode-reporting-qa-spec.md](docs/qa/backend/auth-mode-reporting-qa-spec.md)
